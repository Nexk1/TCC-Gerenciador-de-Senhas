...
<div class="fundo-inicio">   
    <div class="quadrado1">
        ...
        <a href="/User/{{$page_id}}"><p class="notas-txt">Senhas</p></a>
        <div class="icon-notas"></div>
     

        <button class="pi-txt" onclick="openEntityPanel()">Painel de Identidade</button>
    ...
    <div class="quadrado3">
        <button class="pi-voltar" onclick="closeEntityPanel()">↩</button>
        <img class="profile-img" src="/img/profileimg.jpg" alt="profileimg">
...
<div class="pesquisa">
    <form id="pesquisa" action="{{ route('login', ['page_id' => $page_id]) }}" >
        <input type="text" name="pesquisar" id="pesquisar" class="pesquisar" placeholder="Pesquisar">
    </form>
...
<div class="SHOW-notas">
    @foreach ($notas as $nota)
        <div class="show-box-notas">
            <p style="border:1px solid rgb(99, 99, 99);">{{ $nota->titulo}}</p>
            <p>{{ $nota->texto }}</p>
        </div>
    @endforeach
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    botoesVisualizar.forEach(function(botao) {
        ...
        <button class="contas-inicio" onclick="Addnota()">Adicionar Nota</button>

        <script>
            function Addnota(){
                const addnota = document.querySelector('#add-nota');
                addnota.style.display = 'block';
            }

            function FecharAddnota(){
                const addnota = document.querySelector('#add-nota');
                addnota.style.display = 'none';
            }
        </script>

    <div class="add-nota-box">
    
        <form id="add-nota" method="POST" action="{{ route('add_nota_store', ['page_id' => $page_id]) }}">
        @csrf
            <input type="text" name="titulo" placeholder="Titulo" class="add-nota-title" required>
            <br>
            
            <textarea type="text" name="texto" id="texto" placeholder="Sua Nota" class="add-nota"required></textarea>


            <button type="submit" name="action" class="add-nota-btn">
            ...
            <input typer="submit" name="" class="botao-voltar-addnota" value="X" onclick="FecharAddnota()">
    ...
    <!-- <div class="add-conta">
        ...
        <div class="icon-notas"><svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512"><style>svg{fill:#ffffff}</style><path d="M336 352c97.2 0 176-78.8 176-176S433.2 0 336 0S160 78.8 160 176c0 18.7 2.9 36.8 8.3 53.7L7 391c-4.5 4.5-7 10.6-7 17v80c0 13.3 10.7 24 24 24h80c13.3 0 24-10.7 24-24V448h40c13.3 0 24-10.7 24-24V384h40c6.4 0 12.5-2.5 17-7l33.3-33.3c16.9 5.4 35 8.3 53.7 8.3zM376 96a40 40 0 1 1 0 80 40 40 0 1 1 0-80z"/></svg></div>
        ...
        <div class="icon-add-conta"><svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 384 512"><style>svg{fill:#ffffff}</style><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z"/></svg></div>
    ...
    <div class="config"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><style>svg{fill:#ffffff}</style><path d="M0 416c0 17.7 14.3 32 32 32l54.7 0c12.3 28.3 40.5 48 73.3 48s61-19.7 73.3-48L480 448c17.7 0 32-14.3 32-32s-14.3-32-32-32l-246.7 0c-12.3-28.3-40.5-48-73.3-48s-61 19.7-73.3 48L32 384c-17.7 0-32 14.3-32 32zm128 0a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zM320 256a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm32-80c-32.8 0-61 19.7-73.3 48L32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l246.7 0c12.3 28.3 40.5 48 73.3 48s61-19.7 73.3-48l54.7 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-54.7 0c-12.3-28.3-40.5-48-73.3-48zM192 128a32 32 0 1 1 0-64 32 32 0 1 1 0 64zm73.3-64C253 35.7 224.8 16 192 16s-61 19.7-73.3 48L32 64C14.3 64 0 78.3 0 96s14.3 32 32 32l86.7 0c12.3 28.3 40.5 48 73.3 48s61-19.7 73.3-48L480 128c17.7 0 32-14.3 32-32s-14.3-32-32-32L265.3 64z"/></svg>
        <h3 class="config-txt">configurações</h3>
    </div>
    <div class="contato"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><style>svg{fill:#ffffff}</style><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg>
        <h3 class="contate-nos">contate-nos</h3>
    </div>
    <div class="avaliar">
        
        <p class="nos-avalie">Nos avalie</p>
    ...
    <div class="logout">
        <a href="/" class="link-logout"><p><img src="/img/logouticon.png" alt="logout">Log-out</p></a>
    </div>
